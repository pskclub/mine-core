...
-----END PUBLIC KEY-----`
	...
	pub = `-----BEGIN PUBLIC KEY-----
MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEeW35ee0i5vU9p66m+sDG21atXaQw
FW/uYktAfcnfu28IPDoVgeU7L/GggcxOD+Q6zh4SyviIDlJgzDbfHAbBwg==
-----END PUBLIC KEY-----`

	sig = "MEUCIQDRQ8U7rtfK1mw2zR49H8+CL/B/eat+KriJkftRai9ZBwIgdoQAEZoqjZYNbM14+sE1tlTzr6AYN/GLnTOY6kY1PnY="
	msg = "ewogICJpZCI6ICJiYjBjMTdiNWFmNzI3M2QyMDM2OWIxZTM3MzI4MjhiZGFlZDRiZWMyODViOWUzYmU0NmM3MTk4MjBjNjg1OTVmIiwKICAidXNlcl9pZCI6ICI1ODQiLAogICJhY3Rpb24iOiAiTE9HSU4iLAogICJ2ZXJpZmllZCI6IGZhbHNlCn0K"
	valid, err = VerifySignature(pub, sig, msg)
	assert.NoError(t, err)
	assert.Equal(t, true, valid)
}
